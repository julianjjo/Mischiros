...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'iga_rss.rss' => 'getIgaRss_RssService',
            ...
            'mischiros_tienda.admin.ingreso' => 'getMischirosTienda_Admin_IngresoService',
            'mischiros_tienda.admin.medida' => 'getMischirosTienda_Admin_MedidaService',
            'mischiros_tienda.admin.prenda' => 'getMischirosTienda_Admin_PrendaService',
            'mischiros_tienda.admin.talla' => 'getMischirosTienda_Admin_TallaService',
            'mischiros_tienda.admin.tipo' => 'getMischirosTienda_Admin_TipoService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('config' => new \Symfony\Bundle\AsseticBundle\Factory\Loader\ConfigurationLoader(), 'twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('bootstrap_css' => array(0 => array(0 => '/var/www/app/../vendor/twbs/bootstrap/less/bootstrap.less', 1 => '/var/www/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/DependencyInjection/../Resources/less/form.less'), 1 => array(0 => 'less'), 2 => array('output' => 'css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => '/var/www/app/../vendor/twbs/bootstrap/js/transition.js', 1 => '/var/www/app/../vendor/twbs/bootstrap/js/alert.js', 2 => '/var/www/app/../vendor/twbs/bootstrap/js/button.js', 3 => '/var/www/app/../vendor/twbs/bootstrap/js/carousel.js', 4 => '/var/www/app/../vendor/twbs/bootstrap/js/collapse.js', 5 => '/var/www/app/../vendor/twbs/bootstrap/js/dropdown.js', 6 => '/var/www/app/../vendor/twbs/bootstrap/js/modal.js', 7 => '/var/www/app/../vendor/twbs/bootstrap/js/tooltip.js', 8 => '/var/www/app/../vendor/twbs/bootstrap/js/popover.js', 9 => '/var/www/app/../vendor/twbs/bootstrap/js/scrollspy.js', 10 => '/var/www/app/../vendor/twbs/bootstrap/js/tab.js', 11 => '/var/www/app/../vendor/twbs/bootstrap/js/affix.js', 12 => '/var/www/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/DependencyInjection/../Resources/js/bc-bootstrap-collection.js'), 1 => array(), 2 => array('output' => 'js/bootstrap.js')), 'jquery' => array(0 => array(0 => '/var/www/app/../vendor/jquery/jquery/jquery-1.10.2.js'), 1 => array(), 2 => array('output' => 'js/jquery.js')))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSCommentBundle', '/var/www/app/Resources/FOSCommentBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSCommentBundle', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('/etc/alternatives/node', array(0 => '/etc/alternatives/node', 1 => '/usr/local/lib/node_modules'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Tienda', 'user' => 'root', 'password' => 'poloji', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/var/www/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine' => 'FOS\\UserBundle\\Entity', '/var/www/vendor/sonata-project/user-bundle/Resources/config/doctrine' => 'Sonata\\UserBundle\\Entity', '/var/www/src/Application/Sonata/UserBundle/Resources/config/doctrine' => 'Application\\Sonata\\UserBundle\\Entity', '/var/www/vendor/sonata-project/media-bundle/Resources/config/doctrine' => 'Sonata\\MediaBundle\\Entity', '/var/www/src/Application/Sonata/MediaBundle/Resources/config/doctrine' => 'Application\\Sonata\\MediaBundle\\Entity', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/config/doctrine' => 'FOS\\CommentBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/src/Mischiros/TiendaBundle/Entity')), 'Mischiros\\TiendaBundle\\Entity');
    ...
    {
        return $this->services['fos_comment.form_type.comment.default'] = new \FOS\CommentBundle\Form\CommentType('Mischiros\\TiendaBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.commentable_thread.default'] = new \FOS\CommentBundle\Form\CommentableThreadType('Mischiros\\TiendaBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.form_type.delete_comment.default'] = new \FOS\CommentBundle\Form\DeleteCommentType('Mischiros\\TiendaBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.thread.default'] = new \FOS\CommentBundle\Form\ThreadType('Mischiros\\TiendaBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'Mischiros\\TiendaBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.entity_manager'), 'Mischiros\\TiendaBundle\\Entity\\Thread');
    }
    ...
    /**
     * Gets the 'iga_rss.rss' service.
     *
     * @return rss_php A rss_php instance.
     */
    protected function getIgaRss_RssService()
    {
        require_once '/var/www/app/../vendor/rssphp/rss.php';
    ...
    {
        return $this->services['imagine.cache.path.resolver'] = new \Avalanche\Bundle\ImagineBundle\Imagine\CachePathResolver('/var/www/app/../web', $this->get('router'));
    }
    ...
    protected function getImagine_ControllerService()
    {
        ...
        return $this->services['imagine.controller'] = $this->scopedServices['request']['imagine.controller'] = new \Avalanche\Bundle\ImagineBundle\Controller\ImagineController($this->get('request'), $this->get('imagine.cache.path.resolver'), $this->get('imagine.gd'), $this->get('imagine.filter.manager'), $this->get('filesystem'), '/var/www/app/../web', '/var/www/app/../web');
    }
    ...
    {
        $this->services['imagine.filter.manager'] = $instance = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\FilterManager(array());
    ...
    {
        return $this->services['imagine.routing.loader'] = new \Avalanche\Bundle\ImagineBundle\Routing\ImagineLoader('media/cache', array());
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => '/var/www/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer', 'Symfony\\Bundle\\SecurityBundle' => '/var/www/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer', 'Symfony\\Bundle\\TwigBundle' => '/var/www/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer', 'Symfony\\Bundle\\MonologBundle' => '/var/www/vendor/symfony/monolog-bundle/Symfony/Bundle/MonologBundle/Resources/config/serializer', 'Symfony\\Bundle\\SwiftmailerBundle' => '/var/www/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/config/serializer', 'Symfony\\Bundle\\AsseticBundle' => '/var/www/vendor/symfony/assetic-bundle/Symfony/Bundle/AsseticBundle/Resources/config/serializer', 'Doctrine\\Bundle\\DoctrineBundle' => '/var/www/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/config/serializer', 'Sensio\\Bundle\\FrameworkExtraBundle' => '/var/www/vendor/sensio/framework-extra-bundle/Sensio/Bundle/FrameworkExtraBundle/Resources/config/serializer', 'Mischiros\\TiendaBundle' => '/var/www/src/Mischiros/TiendaBundle/Resources/config/serializer', 'FOS\\UserBundle' => '/var/www/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/serializer', 'Sonata\\jQueryBundle' => '/var/www/vendor/sonata-project/jquery-bundle/Resources/config/serializer', 'Sonata\\AdminBundle' => '/var/www/vendor/sonata-project/admin-bundle/Resources/config/serializer', 'Sonata\\BlockBundle' => '/var/www/vendor/sonata-project/block-bundle/Resources/config/serializer', 'Sonata\\CoreBundle' => '/var/www/vendor/sonata-project/core-bundle/Resources/config/serializer', 'Sonata\\DoctrineORMAdminBundle' => '/var/www/vendor/sonata-project/doctrine-orm-admin-bundle/Resources/config/serializer', 'Knp\\Bundle\\MenuBundle' => '/var/www/vendor/knplabs/knp-menu-bundle/Knp/Bundle/MenuBundle/Resources/config/serializer', 'Knp\\Bundle\\PaginatorBundle' => '/var/www/vendor/knplabs/knp-paginator-bundle/Knp/Bundle/PaginatorBundle/Resources/config/serializer', 'Sonata\\UserBundle' => '/var/www/vendor/sonata-project/user-bundle/Resources/config/serializer', 'Application\\Sonata\\UserBundle' => '/var/www/src/Application/Sonata/UserBundle/Resources/config/serializer', 'Sonata\\MediaBundle' => '/var/www/vendor/sonata-project/media-bundle/Resources/config/serializer', 'Sonata\\EasyExtendsBundle' => '/var/www/vendor/sonata-project/easy-extends-bundle/Resources/config/serializer', 'Application\\Sonata\\MediaBundle' => '/var/www/src/Application/Sonata/MediaBundle/Resources/config/serializer', 'Braincrafted\\Bundle\\BootstrapBundle' => '/var/www/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/Resources/config/serializer', 'Avalanche\\Bundle\\ImagineBundle' => '/var/www/vendor/avalanche123/imagine-bundle/Avalanche/Bundle/ImagineBundle/Resources/config/serializer', 'FOS\\RestBundle' => '/var/www/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer', 'FOS\\CommentBundle' => '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/config/serializer', 'JMS\\SerializerBundle' => '/var/www/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer', 'Iga\\RssBundle' => '/var/www/src/Iga/RssBundle/Resources/config/serializer', 'Acme\\DemoBundle' => '/var/www/src/Acme/DemoBundle/Resources/config/serializer', 'Symfony\\Bundle\\WebProfilerBundle' => '/var/www/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer', 'Sensio\\Bundle\\DistributionBundle' => '/var/www/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer', 'Sensio\\Bundle\\GeneratorBundle' => '/var/www/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'));
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'BraincraftedBootstrapBundle:Pagination:bootstrap.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    /**
     * Gets the 'mischiros_tienda.admin.ingreso' service.
     *
     * @return Mischiros\TiendaBundle\Admin\IngresoAdmin A Mischiros\TiendaBundle\Admin\IngresoAdmin instance.
     */
    protected function getMischirosTienda_Admin_IngresoService()
    {
        $instance = new \Mischiros\TiendaBundle\Admin\IngresoAdmin('mischiros_tienda.admin.ingreso', 'Mischiros\\TiendaBundle\\Entity\\Ingreso', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('MischirosTiendaBundle');
    ...
    /**
     * Gets the 'mischiros_tienda.admin.medida' service.
     *
     * @return Mischiros\TiendaBundle\Admin\MedidaAdmin A Mischiros\TiendaBundle\Admin\MedidaAdmin instance.
     */
    protected function getMischirosTienda_Admin_MedidaService()
    {
        $instance = new \Mischiros\TiendaBundle\Admin\MedidaAdmin('mischiros_tienda.admin.medida', 'Mischiros\\TiendaBundle\\Entity\\Medida', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'mischiros_tienda.admin.prenda' service.
     *
     * @return Mischiros\TiendaBundle\Admin\PrendaAdmin A Mischiros\TiendaBundle\Admin\PrendaAdmin instance.
     */
    protected function getMischirosTienda_Admin_PrendaService()
    {
        $instance = new \Mischiros\TiendaBundle\Admin\PrendaAdmin('mischiros_tienda.admin.prenda', 'Mischiros\\TiendaBundle\\Entity\\Prenda', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'mischiros_tienda.admin.talla' service.
     *
     * @return Mischiros\TiendaBundle\Admin\TallaAdmin A Mischiros\TiendaBundle\Admin\TallaAdmin instance.
     */
    protected function getMischirosTienda_Admin_TallaService()
    {
        $instance = new \Mischiros\TiendaBundle\Admin\TallaAdmin('mischiros_tienda.admin.talla', 'Mischiros\\TiendaBundle\\Entity\\Talla', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'mischiros_tienda.admin.tipo' service.
     *
     * @return Mischiros\TiendaBundle\Admin\TipoAdmin A Mischiros\TiendaBundle\Admin\TipoAdmin instance.
     */
    protected function getMischirosTienda_Admin_TipoService()
    {
        $instance = new \Mischiros\TiendaBundle\Admin\TipoAdmin('mischiros_tienda.admin.tipo', 'Mischiros\\TiendaBundle\\Entity\\Tipo', 'MischirosTiendaBundle:TipoAdmin');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'main', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '53881d6c6e5ce', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'mischiros_tienda.admin.tipo', 1 => 'mischiros_tienda.admin.talla', 2 => 'mischiros_tienda.admin.medida', 3 => 'mischiros_tienda.admin.prenda', 4 => 'mischiros_tienda.admin.ingreso', 5 => 'sonata.user.admin.user', 6 => 'sonata.user.admin.group', 7 => 'sonata.media.admin.media', 8 => 'sonata.media.admin.gallery', 9 => 'sonata.media.admin.gallery_has_media'));
        $instance->setAdminGroups(array('Tienda' => array('label' => 'Tienda', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'mischiros_tienda.admin.tipo', 1 => 'mischiros_tienda.admin.talla', 2 => 'mischiros_tienda.admin.medida', 3 => 'mischiros_tienda.admin.prenda', 4 => 'mischiros_tienda.admin.ingreso')), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group')), 'sonata_media' => array('label' => 'sonata_media', 'label_catalogue' => 'SonataMediaBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.media.admin.media', 1 => 'sonata.media.admin.gallery'))));
        $instance->setAdminClasses(array('Mischiros\\TiendaBundle\\Entity\\Tipo' => array(0 => 'mischiros_tienda.admin.tipo'), 'Mischiros\\TiendaBundle\\Entity\\Talla' => array(0 => 'mischiros_tienda.admin.talla'), 'Mischiros\\TiendaBundle\\Entity\\Medida' => array(0 => 'mischiros_tienda.admin.medida'), 'Mischiros\\TiendaBundle\\Entity\\Prenda' => array(0 => 'mischiros_tienda.admin.prenda'), 'Mischiros\\TiendaBundle\\Entity\\Ingreso' => array(0 => 'mischiros_tienda.admin.ingreso'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group'), 'Application\\Sonata\\MediaBundle\\Entity\\Media' => array(0 => 'sonata.media.admin.media'), 'Application\\Sonata\\MediaBundle\\Entity\\Gallery' => array(0 => 'sonata.media.admin.gallery'), 'Application\\Sonata\\MediaBundle\\Entity\\GalleryHasMedia' => array(0 => 'sonata.media.admin.gallery_has_media')));
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('/var/www/app/cache/dev/sonata/admin', true);
    }
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'mischiros_tienda.admin.tipo', 1 => 'mischiros_tienda.admin.talla', 2 => 'mischiros_tienda.admin.medida', 3 => 'mischiros_tienda.admin.prenda', 4 => 'mischiros_tienda.admin.ingreso', 5 => 'sonata.user.admin.user', 6 => 'sonata.user.admin.group', 7 => 'sonata.media.admin.media', 8 => 'sonata.media.admin.gallery', 9 => 'sonata.media.admin.gallery_has_media'), $this);
    }
    ...
    {
        return $this->services['sonata.block.form.type.block'] = new \Sonata\BlockBundle\Form\Type\ServiceListType($this->get('sonata.block.manager'), array('admin' => array(0 => 'sonata.admin.block.admin_list'), 'cms' => array(0 => 'sonata.block.service.text', 1 => 'sonata.user.block.menu', 2 => 'sonata.user.block.account', 3 => 'sonata.block.service.action', 4 => 'sonata.block.service.rss')));
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.admin_list', 1 => 'sonata.block.service.text', 2 => 'sonata.user.block.menu', 3 => 'sonata.user.block.account', 4 => 'sonata.block.service.action', 5 => 'sonata.block.service.rss'));
    }
    ...
    {
        return $this->services['sonata.media.adapter.filesystem.local'] = new \Sonata\MediaBundle\Filesystem\Local('/var/www/app/../web/uploads/media', false);
    }
    ...
    {
        return $this->services['sonata.media.manager.media'] = new \Sonata\MediaBundle\Entity\MediaManager('Application\\Sonata\\MediaBundle\\Entity\\Media', $this->get('doctrine'), $this->get('sonata.media.pool'));
    }
    ...
    protected function getSonata_Media_PoolService()
    {
        ...
        $instance->addContext('default', array(0 => 'sonata.media.provider.dailymotion', 1 => 'sonata.media.provider.youtube', 2 => 'sonata.media.provider.image', 3 => 'sonata.media.provider.file'), array('default_small' => array('width' => 100, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true), 'default_big' => array('width' => 700, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
        $instance->addContext('prenda', array(0 => 'sonata.media.provider.image'), array('prenda_chica' => array('width' => 200, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true), 'prenda_media' => array('width' => 350, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true), 'prenda_grande' => array('width' => 700, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.public_strategy', 'mode' => 'http'));
        ...
        $instance->addDownloadSecurity('sonata.media.security.public_strategy', $this->get('sonata.media.security.public_strategy'));
    ...
    protected function getSonata_Media_Provider_DailymotionService()
    {
        ...
        $instance->addFormat('default_big', array('width' => 700, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
    ...
    protected function getSonata_Media_Provider_ImageService()
    {
        ...
        $instance->addFormat('default_small', array('width' => 100, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('default_big', array('width' => 700, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('prenda_chica', array('width' => 200, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('prenda_media', array('width' => 350, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('prenda_grande', array('width' => 700, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
    ...
    {
        return $this->services['sonata.user.editable_role_builder'] = new \Sonata\UserBundle\Security\EditableRolesBuilder($this->get('security.context'), $this->get('sonata.admin.pool'), array('ROLE_ADMIN' => array(0 => 'ROLE_STAFF', 1 => 'ROLE_SONATA_FOO_EDITOR', 2 => 'ROLE_SONATA_FOO_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('julian.mican@gmail.com');
        $a->setPassword('polojilop@87');
        $a->setAuthMode('login');
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('xlf', '/var/www/src/Mischiros/TiendaBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        ...
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.hr.xliff', 'hr', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.pt_BR.xliff', 'pt_BR', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/FOSUserBundle.fr.xliff', 'fr', 'FOSUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.cs.xliff', 'cs', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.ru.xliff', 'ru', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.fr.xliff', 'fr', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.sl.xliff', 'sl', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.bg.xliff', 'bg', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.lt.xliff', 'lt', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.pt.xliff', 'pt', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.ca.xliff', 'ca', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/FOSUserBundle.en.xliff', 'en', 'FOSUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.es.xliff', 'es', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/FOSUserBundle.es.xliff', 'es', 'FOSUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.pl.xliff', 'pl', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.de.xliff', 'de', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.nl.xliff', 'nl', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.it.xliff', 'it', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.fa.xliff', 'fa', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.sk.xliff', 'sk', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/FOSUserBundle.hr.xliff', 'hr', 'FOSUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.en.xliff', 'en', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/user-bundle/Resources/translations/SonataUserBundle.zh_TW.xliff', 'zh_TW', 'SonataUserBundle');
        $instance->addResource('yml', '/var/www/src/Application/Sonata/UserBundle/Resources/translations/FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('xliff', '/var/www/src/Application/Sonata/UserBundle/Resources/translations/SonataUserBundle.es.xliff', 'es', 'SonataUserBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.ru.xliff', 'ru', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.fr.xliff', 'fr', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.pl.xliff', 'pl', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.lt.xliff', 'lt', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.nl.xliff', 'nl', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.es.xliff', 'es', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.en.xliff', 'en', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.de.xliff', 'de', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.pt_BR.xliff', 'pt_BR', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.hu.xliff', 'hu', 'SonataMediaBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/media-bundle/Resources/translations/SonataMediaBundle.sl.xliff', 'sl', 'SonataMediaBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.sr_Latn.yml', 'sr_Latn', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.zh_CN.yml', 'zh_CN', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.it.yml', 'it', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.bg.yml', 'bg', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.pl.yml', 'pl', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.sr_Cyrl.yml', 'sr_Cyrl', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.fi.yml', 'fi', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.nl.yml', 'nl', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.da.yml', 'da', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.ru.yml', 'ru', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.en.yml', 'en', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.es.yml', 'es', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.pt.yml', 'pt', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.mn.yml', 'mn', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.sl.yml', 'sl', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.fr.yml', 'fr', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.fa_IR.yml', 'fa_IR', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.et.yml', 'et', 'FOSCommentBundle');
        $instance->addResource('yml', '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/translations/FOSCommentBundle.de.yml', 'de', 'FOSCommentBundle');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 2 => 'SonataUserBundle:Form:form_admin_fields.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/src/Mischiros/TiendaBundle/Resources/views', 'MischirosTienda');
        ...
        $instance->addPath('/var/www/vendor/knplabs/knp-paginator-bundle/Knp/Bundle/PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('/var/www/vendor/sonata-project/user-bundle/Resources/views', 'SonataUser');
        $instance->addPath('/var/www/src/Application/Sonata/UserBundle/Resources/views', 'ApplicationSonataUser');
        $instance->addPath('/var/www/vendor/sonata-project/media-bundle/Resources/views', 'SonataMedia');
        $instance->addPath('/var/www/src/Application/Sonata/MediaBundle/Resources/views', 'ApplicationSonataMedia');
        $instance->addPath('/var/www/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/Resources/views', 'BraincraftedBootstrap');
        $instance->addPath('/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/views', 'FOSComment');
        $instance->addPath('/var/www/src/Iga/RssBundle/Resources/views', 'IgaRss');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_STAFF', 1 => 'ROLE_SONATA_FOO_EDITOR', 2 => 'ROLE_SONATA_FOO_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MischirosTiendaBundle' => 'Mischiros\\TiendaBundle\\MischirosTiendaBundle',
                ...
                'IgaRssBundle' => 'Iga\\RssBundle\\IgaRssBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'poloji',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'julian.mican@gmail.com',
            'mailer_password' => 'polojilop@87',
            'locale' => 'es',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                ...
                2 => '/var/www/vendor/sonata-project/media-bundle/Resources/config/validation.xml',
                3 => '/var/www/vendor/friendsofsymfony/comment-bundle/FOS/CommentBundle/Resources/config/validation.xml',
                4 => '/var/www/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation/orm.xml',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'julian.mican@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'polojilop@87',
            ...
            'assetic.filter.less.node' => '/etc/alternatives/node',
            'assetic.filter.less.node_paths' => array(
                0 => '/etc/alternatives/node',
            ...
            'sonata.admin.configuration.dashboard_blocks' => array(
                ...
                1 => array(
                    ...
                    'settings' => array(
                        'content' => '<h2>Bienvenido al panel de administracion de Mischiros.com</h2> <p>Podra crear, modificar, eliminar e ingresar nuevas prendas a la Mischiros.com</p>',
                    ),
                    'class' => 'col-md-4',
                ),
            ),
            ...
            'braincrafted_bootstrap.customize' => array(
                'variables_file' => NULL,
                'bootstrap_output' => '/var/www/app/Resources/less/bootstrap.less',
                'bootstrap_template' => 'BraincraftedBootstrapBundle:Bootstrap:bootstrap.less.twig',
            ),
            'braincrafted_bootstrap.assets_dir' => '/var/www/app/../vendor/twbs/bootstrap',
            'braincrafted_bootstrap.output_dir' => NULL,
            'braincrafted_bootstrap.less_filter' => 'less',
            'imagine.web_root' => '/var/www/app/../web',
            'imagine.source_root' => '/var/www/app/../web',
            ...
            'fos_comment.model.thread.class' => 'Mischiros\\TiendaBundle\\Entity\\Thread',
            'fos_comment.model.comment.class' => 'Mischiros\\TiendaBundle\\Entity\\Comment',
            ...
            'iga_rss.file' => '/var/www/app/../vendor/rssphp/rss.php',
            'iga_rss.rss' => NULL,
            'iga_rss.rss.class' => 'rss_php',
